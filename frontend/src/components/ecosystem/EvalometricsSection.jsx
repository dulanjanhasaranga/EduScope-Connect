        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="flex-1 w-full max-w-2xl">
            <motion.div 
              ...
              className="rounded-xl bg-[#161b22] border border-[#30363d] overflow-hidden shadow-2xl"
            >
              {/* Editor Header */}
              <div className="bg-[#0d1117] border-b border-[#30363d] px-4 py-3 flex items-center gap-2">
                ...
                <div className="ml-4 text-xs font-mono text-[#8b949e]">test_chatbot.py</div>
              </div>
              
              {/* Editor Body */}
              <div className="p-4 overflow-x-auto text-sm font-mono leading-loose">
...
{'    '})
              ...
              {/* Terminal Execution */}
              <div className="border-t border-[#30363d] bg-[#0d1117] p-4 text-xs font-mono">
                <div className="flex items-center gap-2 text-[#8b949e]">
                  <span className="text-emerald-400">➜</span>
                  <span>evalometrics</span> <span className="text-white">pytest test_chatbot.py</span>
                </div>
