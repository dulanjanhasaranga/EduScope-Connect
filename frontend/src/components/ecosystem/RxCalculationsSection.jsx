            ...
            >
              ...
              <div className="p-8">
                ...
                <div className="space-y-3">
                  <div className="p-4 rounded-xl border-2 border-slate-200 hover:border-red-200 hover:bg-red-50 cursor-pointer transition-colors flex justify-between items-center group">
                    <span className="font-bold text-slate-700 group-hover:text-red-700">A. 5 mL</span>
                    <div className="w-5 h-5 rounded-full border-2 border-slate-300 group-hover:border-red-400"></div>
                  </div>
                  <div className="p-4 rounded-xl border-2 border-red-500 bg-red-50 flex justify-between items-center">
                    <span className="font-bold text-red-700">B. 10 mL</span>
                    <div className="w-5 h-5 rounded-full bg-red-500 border-2 border-red-500 flex items-center justify-center">
                      <div className="w-2 h-2 bg-white rounded-full"></div>
                    </div>
                  </div>
                  <div className="p-4 rounded-xl border-2 border-slate-200 hover:border-red-200 hover:bg-red-50 cursor-pointer transition-colors flex justify-between items-center group">
                    <span className="font-bold text-slate-700 group-hover:text-red-700">C. 15 mL</span>
                    <div className="w-5 h-5 rounded-full border-2 border-slate-300 group-hover:border-red-400"></div>
                  </div>
                  <div className="p-4 rounded-xl border-2 border-slate-200 hover:border-red-200 hover:bg-red-50 cursor-pointer transition-colors flex justify-between items-center group">
                    <span className="font-bold text-slate-700 group-hover:text-red-700">D. 20 mL</span>
                    <div className="w-5 h-5 rounded-full border-2 border-slate-300 group-hover:border-red-400"></div>
                  </div>
                </div>
                
                <div className="mt-8 flex justify-between items-center">
                  <button className="text-slate-500 font-bold hover:text-slate-700">Previous</button>
                  <button className="bg-slate-900 text-white px-6 py-2.5 rounded-xl font-bold shadow-md hover:bg-slate-800 transition-colors">Submit Answer</button>
                </div>
              </div>
            </motion.div>
          </div>
